...
export interface RouteSummary { durationMinutes: number; distanceMeters: number; cost: number | null; costCurrency?: string; costNote?: string; error?: string; approximate?: boolean; }
