...
interface TravelPlanContextValue { plan: TravelPlan | null; setPlan: (plan: TravelPlan | null) => void; setDayStartTime: (date: string, time: string) => void; addSpot: (spot: Spot, travelDate?: string, mode?: TransportMode) => void; removeSpot: (id: string) => void; reorderSpot: (id: string, targetIndex: number) => void; setTransport: (index: number, mode: TransportMode) => void; setRoute: (index: number, route: RouteSummary | null) => void; save: () => Promise<void>; }
