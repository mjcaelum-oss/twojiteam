...
export interface OpenAIRecommendationInput { destination: Destination; preferences: TravelPreferences; spots: Spot[]; selectedIds: string[]; rejectedIds: string[]; previousSpotId?: string; recommendationTime?: string; }
